<?php
    ...
    $gue_id = $_GET['gue_id'];
    //通过这个主键做为条件查询当前详细数据
    $data =$db->select_one('guestbook','*',"gue_id = $gue_id");
    ...
    if ($_POST) {
        ...
        $gue_id = $_POST['gue_id'];
        //执行编辑函数
        $res = $db->edit('guestbook',$data, "gue_id = $gue_id");
        if ($res) {
        ...
        <form action="" method="post" class="cmxform">
            ...
            <div class="panel-body">
                  ...
                  <div class="form-group">
                      <div class="input-group"> <span class="input-group-addon">留言名称</span>
                          <input type="text" name="gue_name" value="<?php echo $data['gue_name'];?>" class="form-control">
                      </div>
                  </div>
                  <div class="form-group">
                      <div class="input-group"> <span class="input-group-addon">留言主题</span>
