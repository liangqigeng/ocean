<?php
    ...
    $cat_id = $_GET['cat_id'];
    //通过这个主键做为条件查询当前详细数据
    $data = $db->select_one('cat_new','*',"cat_id = $cat_id");
    ...
    if ($_POST) {
        ...
        $cat_id = $_POST['cat_id'];
        //执行添加函数
        $res = $db->edit('cat_new',$data, "cat_id = $cat_id");
        if ($res) {
            show_msg('修改成功','new_cat_list.php');
        } else {
            show_msg('数据执行有误，请重试...');
        }
    }
	 ...
	 <div class="row">
        ...
        <form action="" method="post" class="cmxform">
            ...
            <div class="panel-heading">
              <div class="panel-title">添加新闻分类</div>
              <div class="panel-btns pull-right margin-left">
              <a href="new_cat_list.php" class="btn btn-default btn-gradient dropdown-toggle"><span class="glyphicon glyphicon-chevron-left"></span></a>
            	  </div>
            </div>
