<?php
    if (!empty($_SESSION['is_login'])) {
        ...
        if ($is_login != 1) {
            ...
            mysqli_query($db->conn, "UPDATE {$db->fix}admin SET `admin_lasttime` = {$_COOKIE['admin_lasttime']} WHERE admin_name = '{$_COOKIE['admin_name']}'");
        }
    } else {
            show_msg('请先登录', 'login.php');
        }
...
<header class="navbar navbar-fixed-top" style="background-image: none; background-color: rgb(240, 240, 240);">
    <div class="pull-left"> <a class="navbar-brand" href="#">
           <h2 style="width:270px;color:darkred">海洋文化公司后台管理系统</h2>
        </a> </div>
